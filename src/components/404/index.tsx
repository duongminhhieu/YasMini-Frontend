      ...
      <div className="flex flex-column align-items-center justify-content-center">
        ...
        >
          ...
          >
            ...
            <h1 className="text-red-700 font-bold text-5xl mb-2">404 NOT FOUND</h1>
            <div className="text-600 mb-5">Not Avaiable</div>
            <Link to="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
              ...
              <span className="ml-4 flex flex-column">
                <span className="text-900 lg:text-xl font-medium mb-1">Back Home</span>
                <span className="text-600 lg:text-lg">Back To Home</span>
              </span>
            </Link>
          </div>
        </div>
